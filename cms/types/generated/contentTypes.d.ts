...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    source: Schema.Attribute.Enumeration<['news', 'root']> &
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footerHtml: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global.global'
    ...
    publishedAt: Schema.Attribute.DateTime;
    sideMenu: Schema.Attribute.JSON;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Landing and static pages';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
  ...
  attributes: {
    ...
    pageType: Schema.Attribute.Enumeration<['landing', 'static', 'home']> &
