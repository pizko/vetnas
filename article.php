...
$item = find_article_by_slug($slug);
if ($item === null || !is_visible_now($item)) {
    http_response_code(404);
    echo 'Статья не найдена';
    exit;
}

$title = trim((string)($item['title'] ?? 'Статья'));
$metaDescription = trim((string)($item['meta_description'] ?? ''));
$metaKeywords = trim((string)($item['meta_keywords'] ?? ''));
$contentHtml = (string)($item['content_html'] ?? '<p>Контент отсутствует.</p>');
$selfUrl = 'article.php?slug=' . rawurlencode($slug);
?>
...
<script src="jquery.min.js"></script>
 	...
 	<script src="do.js@rnd=1767606866"></script>
	<link rel="stylesheet" href="styles_articles_tpl.css">
	<link rel="stylesheet" href="animate.css">
	<link rel="stylesheet" href="modules_patch.scss.css@rnd=1767606866.css">
...
<a href="index.html.1.html" class="mosaic-crumbs__item_link mosaic-crumbs__item_link--u-i7wri0h7l" ><span class="text-block-wrap-div">Главная</span></a><span class="mosaic-crumbs__delimiter mosaic-crumbs__delimiter--u-iirpqk5ih">/</span><a href="novosti.php" class="mosaic-crumbs__item_link mosaic-crumbs__item_link--u-i7wri0h7l"><span class="text-block-wrap-div">Новости</span></a><span class="mosaic-crumbs__delimiter mosaic-crumbs__delimiter--u-iirpqk5ih">/</span><span class="mosaic-crumbs__last mosaic-crumbs__last--u-igmse83rc"><span class="text-block-wrap-div"><?= e($title) ?></span></span>
</div>
